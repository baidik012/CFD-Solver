"""Staggered cavity example (YAML-configurable).

Run: python3 examples/staggered_cavity.py --config examples/staggered_cavity.yaml
"""
...
def main():
    ...
    save_velocity_contour(solver, 'output/staggered_result.png', skip=skip, scale=scale)
    print('Saved output/staggered_result.png')
